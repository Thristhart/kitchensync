    ...
    namespace.on('connection', function(socket) {
      ...
      socket.once('ident', function(name) {
        ...
        socket.on('say', function(message) {
          if(message) {
            var cleanMessage = validator.toString(message);
